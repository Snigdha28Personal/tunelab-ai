...
import { X, Layers, Sparkles, Award } from "lucide-react";
...
export function AboutModal({ isOpen, onClose }: AboutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-4xl rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto my-8">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute right-4 top-4 rounded-lg bg-slate-100 p-1.5 text-slate-500 hover:bg-slate-200 hover:text-slate-900"
        >
          <X className="h-5 w-5" />
        </button>
        ...
        <div className="flex items-center space-x-3 border-b border-slate-100 pb-4">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 to-purple-600 p-0.5">
            <div className="flex h-full w-full items-center justify-center rounded-[10px] bg-white">
              <Layers className="h-5 w-5 text-indigo-600" />
            </div>
          </div>
          <div>
            <h2 className="text-xl font-extrabold text-slate-900">About TuneLab — PM Portfolio Showcase</h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 text-xs">
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-2">
            <h3 className="font-bold text-indigo-700 uppercase tracking-wider text-[11px]">Product Problem</h3>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-2">
            <h3 className="font-bold text-purple-700 uppercase tracking-wider text-[11px]">Product Solution</h3>
            <p className="text-slate-700 leading-relaxed font-medium">
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-5 space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
            <div className="rounded-lg bg-white p-2.5 border border-slate-200 text-slate-800 font-bold shadow-2xs">
              • AI Product Strategy
            </div>
            <div className="rounded-lg bg-white p-2.5 border border-slate-200 text-slate-800 font-bold shadow-2xs">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3 text-xs">
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 space-y-1">
              <strong className="text-indigo-900 font-bold block">1. Why compare against a baseline?</strong>
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 space-y-1">
              <strong className="text-indigo-900 font-bold block">2. Why held-out test sets & data leakage prevention?</strong>
              <p className="text-slate-700 font-medium">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 space-y-1">
              <strong className="text-indigo-900 font-bold block">3. Why Macro F1 instead of simple accuracy?</strong>
              <p className="text-slate-700 font-medium">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 space-y-1">
              <strong className="text-indigo-900 font-bold block">4. Why evaluate cost & latency alongside quality?</strong>
              <p className="text-slate-700 font-medium">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 space-y-1">
              <strong className="text-indigo-900 font-bold block">5. What is the core AI product decision philosophy?</strong>
